...
export const Contact: React.FC = () => {
  ...
  return (
    <>
      <SEOHead 
        title="Contact Us | CCWA International" 
        description="Get in touch with CCWA International. We'd love to hear from you regarding sponsorships, partnerships, or any general enquiries."
      />
      ...
      <section className="relative w-full h-[40vh] min-h-[300px] flex items-center justify-center bg-primary overflow-hidden">
        ...
        <div className="relative z-10 text-center text-bg px-4">
          ...
          >
            <h1 className="font-display font-bold text-4xl md:text-5xl lg:text-6xl mb-4">Contact Us</h1>
      ...
      {/* 2. FORM & DETAILS TWO-COLUMN LAYOUT */}
      <section className="py-20 md:py-28 bg-bg">
        <div className="container mx-auto px-4 md:px-6 lg:px-8 max-w-7xl">
          <div className="flex flex-col lg:flex-row gap-16 lg:gap-24">
            ...
            >
              <h2 className="font-display font-bold text-4xl md:text-5xl text-primary mb-10 leading-tight">
                Get in Touch
              </h2>
              ...
              <div className="space-y-8">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-bold text-text text-lg mb-1">CCWA Headquarters</h4>
                    <p className="text-text opacity-80 leading-relaxed font-body">
                      No.3 Church Crescent Opposite Rano Oil & Gas, beside The Apostolic Church Nyanya-Karshi Road Abuja.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-bold text-text text-lg mb-1">Phone</h4>
                    <p className="text-text opacity-80 leading-relaxed font-body">
                      0817-541-7583<br/>
                      0706-069-3615
                    </p>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-bold text-text text-lg mb-1">Email</h4>
                    <p className="text-text opacity-80 leading-relaxed font-body">
                      <a href="mailto:ccwahdqtrs@gmail.com" className="hover:text-secondary transition-colors">ccwahdqtrs@gmail.com</a>
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-12 pt-8 border-t border-gray-200">
                ...
                <div className="flex gap-4">
                  <a href="#" aria-label="Facebook" className="w-10 h-10 bg-primary text-white rounded-full flex items-center justify-center hover:bg-secondary transition-colors">
                    {/* Facebook Icon Placeholder */}
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clipRule="evenodd" /></svg>
                  </a>
                  <a href="#" aria-label="Instagram" className="w-10 h-10 bg-primary text-white rounded-full flex items-center justify-center hover:bg-secondary transition-colors">
                  ...
                  <a href="#" aria-label="YouTube" className="w-10 h-10 bg-primary text-white rounded-full flex items-center justify-center hover:bg-secondary transition-colors">
                  ...
                  <a href="#" aria-label="X / Twitter" className="w-10 h-10 bg-primary text-white rounded-full flex items-center justify-center hover:bg-secondary transition-colors">
                    {/* X Icon Placeholder */}
      ...
      <section className="pb-24 bg-bg">
        <div className="container mx-auto px-4 md:px-6 lg:px-8 max-w-7xl">
          <motion.div 
            ...
            viewport={{ once: true, margin: "-100px" }}
            transition={{ duration: 0.6 }}
            className="w-full h-[400px] rounded-2xl overflow-hidden shadow-lg border border-gray-200 bg-gray-100 flex items-center justify-center"
          >
            {mapEmbedUrl ? (
              <iframe 
                src={mapEmbedUrl}
                ...
                title="CCWA Office Location Map"
              ></iframe>
            ) : (
              <div className="text-center p-6">
                ...
                <p className="text-gray-400 text-sm mt-1">Please configure VITE_GOOGLE_MAPS_EMBED_URL</p>
              </div>
            )}
          </motion.div>
        </div>
